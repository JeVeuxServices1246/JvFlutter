...
class StoreScreenuser extends StatefulWidget {
  const StoreScreenuser({super.key});

  @override
  State<StoreScreenuser> createState() => _StoreScreenuserState();
}

class _StoreScreenuserState extends State<StoreScreenuser> {
  List categoryList = [
    'Ro water purifier',
    'Home upgrades',
    'Electrical fitting',
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              buildCategoryUI(categoryList, 'assets/images/rowater.png'),
              const SizedBox(
                height: 33,
              ),
