...
class _HomeServiceState extends State<HomeService> {
  ...
  List repairList = ['water Purifier Service', 'Washing Machine'];
  @override
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              buildCategoryUI(categoryList, 'assets/images/profits.png'),
              const SizedBox(
                height: 33,
              ),
              ...
              browsingAndQuickHomeUI('Quick home repairs',
                  'Drill & hang (wall decor)', 'assets/images/drill.png', 215),
              const SizedBox(
                height: 36,
              )
            ],
