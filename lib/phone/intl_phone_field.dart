...
import 'package:jv_app/phone/country_picker_dialog.dart';
...
class _IntlPhoneFieldState extends State<IntlPhoneField> {
  ...
  void initState() {
    ...
    if (widget.initialCountryCode == null && number.startsWith('+')) {
      ...
      _selectedCountry =
          _countryList.firstWhere((item) => item.dialCode == (widget.initialCountryCode ?? '86'), orElse: () => _countryList.first);
